...
### The STSI Way
* _Use a CI server:_ There are several free CI servers available.  We use [Travis](https://travis-ci.org/STSILABS) or [CicleCI](https://circleci.com/gh/STSILABS).  These should be configured to build and test every pull request.
